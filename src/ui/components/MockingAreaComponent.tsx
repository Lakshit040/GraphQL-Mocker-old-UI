  ...
  return (
    <div className="flex flex-col-reverse mt-4">
      <textarea
        ...
        value={mockResponse}
        className="my-2 py-1 px-1 w-full bg-transparent font-mono border border-gray-700 rounded-lg text-xs focus:border-blue-500 focus:ring-blue-500 input-mock-response"
        rows={4}
