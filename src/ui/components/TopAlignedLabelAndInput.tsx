...
const TopAlignedLabelAndInputClass =
  "p-2.5 my-1 h-8 flex-grow xs:w-14 sm:w-25 md:w-40 lg:w-80 text-sm text-white bg-transparent border rounded-xl border-gray-700 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer";
